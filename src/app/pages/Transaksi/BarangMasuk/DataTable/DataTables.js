...
import { EditBarangMasuk } from "../EditBarangMasuk";
import { DeleteBarangMasuk } from "../DeleteBarangMasuk";
      ...
      columnDefs: [
        ...
        { title: "Action", targets: 10 },
        {
          ...
          createdCell: (td, cellData, rowData) =>
            ReactDOM.render(
              <>
                <EditBarangMasuk id={rowData.id} data={rowData} />
                <DeleteBarangMasuk id={rowData.id} />
              </>,
              td
            ),
        },

...
export class SuratIzinKeramaian extends Component {
    render() {
        return (
            <>
                <Card>
                    <CardHeader title="Daftar Pengajuan Surat Keterangan Ijin Keramaian">
                        <CardHeaderToolbar>
                            <button
                                type="button"
                    ...
                    <CardBody>
                        ...
                        {/* <ProductsTable /> */}
                        <Table data={this.dataSet} title="Judul" alamat="Tanggal" nama="Deskripsi" action="Aksi" id="example" class=" display" width="100%" />
                    </CardBody>
                </Card>
            </>
        )
